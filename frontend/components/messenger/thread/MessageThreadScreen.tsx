...
} from "@/app/(protected)/message/t/[threadId]/thread-page-helpers";
import {
  ThreadForwardModal,
  ThreadImageViewer,
  ThreadMembersModal,
...
} from "@/app/(protected)/message/t/[threadId]/thread-page-overlays";
...
export default function MessageThreadScreen() {
  ...
  const handleMessageScroll = useCallback(() => {
    ...
    if (viewport.scrollTop <= LOAD_OLDER_THRESHOLD_PX && !isLoadingOlder && hasMoreOlder) {
    ...
    const scheduleReconnect = () => {
      ...
      echoReconnectTimeoutRef.current = setTimeout(() => {
        try {
          ...
          // Retry loop continues on next state change.
        }
      }, delay);
    };
              ...
              {isBlockedByMe && (
                <div className="mb-3 rounded-3xl border border-slate-200 bg-slate-50 px-4 py-4 text-center">
                  <p className="text-sm font-semibold text-slate-800">
                    You blocked messages from {detailsDisplayName}
                  </p>
                  <p className="mt-1 text-xs text-slate-500">
                    You can&apos;t message them in this chat, and you won&apos;t receive their messages here.
                  </p>
              ...
              {!isBlockedConversation && (
                <>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {editingLoading ? "Saving..." : editingMessageId ? "Save" : "Send"}
                    </Button>
                  </div>
                </>
              )}
